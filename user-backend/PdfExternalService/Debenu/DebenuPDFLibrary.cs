// Ignore Spelling: Annot Barcode Charset Dest Dict Metadata Debenu
...
namespace PdfHandler
{
    ...
    public class DebenuPDFLibrary : IDebenuPdfLibrary, IDisposable
    {
        ...
        public DebenuPDFLibrary(IWebHostEnvironment env, IFileSystem fileSystem, ILogger log, string dllFileName = "DebenuPDFLibrary64DLL1711.dll")
        {
            ...
            else
            {
                if (dllFileName.Contains("DebenuPDFLibraryDLL1711"))
                {
                    ...
                    {
                        log.Error($"DebenuPDFLibrary - Failed While Load Internal DLL. dllFileName = [{dllFileName}] ");
                        _dll = null;
                    }
                }
