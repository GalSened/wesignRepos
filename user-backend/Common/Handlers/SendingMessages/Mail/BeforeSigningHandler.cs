...
{
    public class BeforeSigningHandler : IEmailType
    {
        private readonly IEmailProvider _emailProvider;
        private readonly IShared _shared;
        private readonly IAppendices _appendices;

        public BeforeSigningHandler(IEmailProvider emailProvider, IShared shared, IAppendices appendices)
        {
        ...
        public async Task SendAsync(SmtpConfiguration config, CompanyConfiguration companyConfiguration, MessageInfo messageInfo)
        {
            ...
            if (companyConfiguration?.ShouldAddAppendicesAttachmentsToSendMail ?? false)
            {
