...
{
    public class OnlineHandlerFactory : IDocumentModeHandlerFactory
    {
        ...
        public OnlineHandlerFactory(ILogger logger, ICompanyConnector companyConnector, IDocumentCollectionConnector documentCollectionConnector, IConfiguration configuration, ISignerValidator validator,
        ...
        public IDocumentModeAction Create() => new OnlineHandler(_companyConnector, _configuration, _validator, _sender, _logger, _actionsHelper);
    }
}
