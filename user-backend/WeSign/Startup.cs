namespace WeSign
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Add the UtcDateTimeConverter and NullableUtcDateTimeConverter to the JSON options
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IRecurringJobManager recurringJobManager, IServiceProvider serviceProvider)
        {
            if (_generalSettings.ShowSwaggerUI)
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    //c.SwaggerEndpoint("/swagger/api/swagger.json", "WeSign API V3");
                    //c.SwaggerEndpoint("/swagger/ui/swagger.json", "WeSign UI V3");
                    //c.SwaggerEndpoint("v3/swagger.json", "WeSign V3");
                    //c.SwaggerEndpoint("/swagger/api/swagger.json", "WeSign V3");
                    c.SwaggerEndpoint("v3/swagger.json", "WeSign V3");
           ...
           // app.UseResponseCompression();
            ...
            {
                //•	API users call: https://yourdomain/v3/users/...
                //•	UI calls: https://yourdomain/ui/v3/users/...
            ...
            //recurringJobManager.AddOrUpdate<TemplateMandatorySyncService>(
            //"TemplateMandatorySyncJob",
            //job => job.ExecuteAsync(),
            //"0 0 * * *" // CRON: 00:00 daily
            //);
