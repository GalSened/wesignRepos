namespace WeSign.Extensions
{
    ...
    public static class ConfigurationExtension
    {
        public static void AddConfiguration(this IServiceCollection services, IConfiguration Configuration)
        {
            ...
            var lmsWraperSettings = Configuration.GetSection("LMSWraperSettings");
            ...
            services.Configure<ReCaptchaSettings>(reCaptchaSettingsSection);
            services.Configure<IpRateLimitOptions>(IpRateLimitingSection);
            services.Configure<LMSWraperSettings>(lmsWraperSettings);
