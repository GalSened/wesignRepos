...
namespace DAL.Migrations
{
    ...
    [Migration("20240617120353_AddLastLoginGroupIdTouserTokensDAO")]
    partial class AddLastLoginGroupIdTouserTokensDAO
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DAL.DAOs.Groups.AdditionalGroupMapperDAO", b =>
                {
                    b.HasOne("DAL.DAOs.Companies.CompanyDAO", "Company")
                        .WithOne()
                        .HasForeignKey("DAL.DAOs.Groups.AdditionalGroupMapperDAO", "CompanyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DAL.DAOs.Groups.GroupDAO", "Group")
                        .WithOne()
                        .HasForeignKey("DAL.DAOs.Groups.AdditionalGroupMapperDAO", "GroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
