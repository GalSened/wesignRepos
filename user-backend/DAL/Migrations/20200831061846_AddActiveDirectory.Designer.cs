...
namespace DAL.Migrations
{
    ...
    [Migration("20200831061846_AddActiveDirectory")]
    partial class AddActiveDirectory
    {
            ...
            modelBuilder.Entity("DAL.DAOs.ActiveDirectory.ActiveDirectoryGroupDAO", b =>
                {
                    ...
                    b.ToTable("ActiveDirectoryGroupDAO");
                });
            ...
            modelBuilder.Entity("DAL.DAOs.ActiveDirectory.ActiveDirectoryConfigDAO", b =>
                {
                    b.HasOne("DAL.DAOs.Companies.CompanyDAO", "Company")
                        .WithOne("ActiveDirectoryConfig")
                        .HasForeignKey("DAL.DAOs.ActiveDirectory.ActiveDirectoryConfigDAO", "CompanyId")
