...
namespace DAL.Migrations
{
    ...
    [Migration("20250730054409_updateSystemAdminPassword")]
    partial class updateSystemAdminPassword
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.DAOs.Companies.CompanyConfigurationDAO", b =>
                {
                    ...
                    b.Property<bool>("EnableTabletsSupport")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("ShouldAddAppendicesAttachmentsToSendMail")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("ShouldEnableVideoConference")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DAL.DAOs.Configurations.ConfigurationDAO", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Key = "HistoryIntegratorServiceURL",
                            Value = ""
                        },
                        new
                        {
                            Key = "HistoryIntegratorServiceAPIKey",
                            Value = ""
                        },
                        new
                        {
                        ...
                        new
                        {
                            Key = "IsTemplatesSyncedMandatoryFields",
                            Value = "false"
                        });
                });
            ...
            modelBuilder.Entity("DAL.DAOs.Management.ManagementPeriodicReportDAO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ManagementPeriodicReport");
                });
            ...
            modelBuilder.Entity("DAL.DAOs.Programs.ProgramDAO", b =>
                {
                    ...
                    b.Property<long>("VideoConferencePerMonth")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DAL.DAOs.Programs.ProgramUtilizationDAO", b =>
                {
                    ...
                    b.Property<long>("VideoConference")
                        .HasColumnType("bigint");

                    b.Property<int>("VideoConferenceUsedNotifyCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DAL.DAOs.Reports.ManagementPeriodicReportEmailDAO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ManagementPeriodicReportEmail");
                });

            modelBuilder.Entity("DAL.DAOs.Reports.PeriodicReportFileDAO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PeriodicReportFile");
                });

            modelBuilder.Entity("DAL.DAOs.Templates.SingleLinkAdditionalResourceDAO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SingleLinkAdditionalResources");
                });
            ...
            modelBuilder.Entity("DAL.DAOs.Users.UserDAO", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "SystemAdmin",
                            Password = "8eoSeUxsMDzRPJmPdWfRCnfuqSdfa+tW55g66AJHB7T5u+c550oOuPcuBPuRCyWE",
            ...
            modelBuilder.Entity("DAL.DAOs.Users.UserOtpDetailsDAO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DAL.DAOs.Users.UserPeriodicReportDAO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("DAL.DAOs.Management.ManagementPeriodicReportDAO", b =>
                {
                    b.HasOne("DAL.DAOs.Users.UserDAO", "User")
                        .WithMany("ManagementPeriodicReports")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DAL.DAOs.Reports.ManagementPeriodicReportEmailDAO", b =>
                {
                    b.HasOne("DAL.DAOs.Management.ManagementPeriodicReportDAO", "Report")
                        .WithMany("Emails")
            ...
            modelBuilder.Entity("DAL.DAOs.Users.UserDAO", b =>
                {
                    ...
                    b.Navigation("ManagementPeriodicReports");

                    b.Navigation("UserConfiguration");

                    b.Navigation("UserPeriodicReports");
